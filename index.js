...
const { gerarChaves, gerarChavesHandler } = require('./controllers/gerarChaves');
...
// Connect to MongoDB
mongoose.connect('mongodb+srv://admin:vFp5rkxFODUGGGH7@cluster0.nka2m.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0', {
}).then(() => {
...
const httpsServer = https.createServer( 
  { 
      key: fs.readFileSync(path.join(__dirname,  
          "certificates", "privateKeyServer.pem")), 
      cert: fs.readFileSync(path.join(__dirname, 
          "certificates", "certificateSSL.pem")), 
  }, 
  app 
);
